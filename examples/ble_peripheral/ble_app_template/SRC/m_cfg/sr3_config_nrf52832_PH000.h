...
#ifndef _C006S_CONFIG_PG000_H_
#define _C006S_CONFIG_PG000_H_
...
// <q> Enable MAG
// <i> 使能GEO模块
#define CONFIG_GEOMAGNETIC_ENABLED 1
...
// <q> Enable Vibrator
// <i> 使能震动模块
#define CONFIG_VIBRATOR_ENABLED 1
...
#define CONFIG_WATCH_HAND_ROLLBACK_ENABLED 1
...
#define CONFIG_DEVICE_NAME "C006S"

#define CONFIG_TEST_DEVICE_NAME "C006S--T"
// <s.31> Project Num
// <i> UTF-8 string representing the name of the device.
#define CONFIG_PROJECT_NUM "PH000"
...
#define CONFIG_HARDWARE_REVISION "C006S"
...
#define CONFIG_MIN_CONN_INTERVAL_MS 100
...
#define CONFIG_MAX_CONN_INTERVAL_MS 200
...
//     <24=>P0.24 <25=>P0.25 <26=>P0.26 <27=>P0.27 <28=>P0.28 <29=>P0.29 <30=>P0.30 <31=>P0.31
//     <0xFFFFFFFF=>Disable
#define CONFIG_IO_WATCH_HAND_1_RIGHT 0x0000000C


// <o> Watch hand 2 left pin
//     <0=>P0.0   <1=>P0.1   <2=>P0.2   <3=>P0.3   <4=>P0.4   <5=>P0.5   <6=>P0.6   <7=>P0.7
//     <8=>P0.8   <9=>P0.9   <10=>P0.10 <11=>P0.11 <12=>P0.12 <13=>P0.13 <14=>P0.14 <15=>P0.15
//     <16=>P0.16 <17=>P0.17 <18=>P0.18 <19=>P0.19 <20=>P0.20 <21=>P0.21 <22=>P0.22 <23=>P0.23
//     <24=>P0.24 <25=>P0.25 <26=>P0.26 <27=>P0.27 <28=>P0.28 <29=>P0.29 <30=>P0.30 <31=>P0.31
//     <0xFFFFFFFF=>Disable
#define CONFIG_IO_WATCH_HAND_2_LEFT  9

// <o> Watch hand 2 right pin
//     <0=>P0.0   <1=>P0.1   <2=>P0.2   <3=>P0.3   <4=>P0.4   <5=>P0.5   <6=>P0.6   <7=>P0.7
//     <8=>P0.8   <9=>P0.9   <10=>P0.10 <11=>P0.11 <12=>P0.12 <13=>P0.13 <14=>P0.14 <15=>P0.15
//     <16=>P0.16 <17=>P0.17 <18=>P0.18 <19=>P0.19 <20=>P0.20 <21=>P0.21 <22=>P0.22 <23=>P0.23
//     <24=>P0.24 <25=>P0.25 <26=>P0.26 <27=>P0.27 <28=>P0.28 <29=>P0.29 <30=>P0.30 <31=>P0.31
//     <0xFFFFFFFF=>Disable
#define CONFIG_IO_WATCH_HAND_2_RIGHT 10
// </h>
...
//     <24=>P0.24 <25=>P0.25 <26=>P0.26 <27=>P0.27 <28=>P0.28 <29=>P0.29 <30=>P0.30 <31=>P0.31
//     <0xFFFFFFFF=>Disable
#define CONFIG_IO_BUTTON_WAKEUP 14
...
#define CONFIG_BUTTON_ACT_LOW_MASK 7
// </h> 
...
/**@brief Debug Build */
#define CONFIG_RTT_PROTOCOL_DAILY_SPORT_ENABLED (1 && CONFIG_DEBUG_ENABLED)
...
/**@brief Debug Build */
#define CONFIG_RTT_PROTOCOL_INTERACT_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable Protocol DEV
// <i> Enable m_protocol_devinfo.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_PROTOCOL_DEVINFO_ENABLED (1 && CONFIG_DEBUG_ENABLED)


// <q> Enable Protocol PACK
// <i> Enable m_protocol_pack_trans.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_PROTOCOL_PACK_ENABLED (1 && CONFIG_DEBUG_ENABLED)


// <q> Enable Protocol Link
// <i> Enable m_protocol_link.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_PROTOCOL_LINK_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable Protocol Pack Translate
// <i> Enable m_protocol_pack_trans.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_PROTOCOL_PACK_TRANS_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable Protocol
// <i> Enable protocol.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_PROTOCOL_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable UTC
// <i> Enable utc.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_UTC_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable AD_DataStore
// <i> Enable AD_DataStore.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_AD_DATASTORE_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable App Alarm Clock
// <i> Enable app_alarm_clock.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_APP_ALARM_CLOCK_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable AD Shake
// <i> Enable AD_ShakeHandAlgorithm.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_AD_SHAKE_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable AD SLepp
// <i> Enable AD_SleepAlgorithm.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_AD_SLEEP_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable Idle Judge
// <i> Enable idle_judge.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_IDLE_JUDGE_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable gSensor
// <i> Enable m_gsensor.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_GSENSOR_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable Protocol Sensor Translate
// <i> Enable m_protocol_sensor_trans.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_PROTOCOL_SENSOR_TRANS_ENABLED (1 && CONFIG_DEBUG_ENABLED)


// <q> Enable ANCS
// <i> Enable m_ble_ancs_c.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_ANCS_C_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable DFU
// <i> Enable m_ble_dfu.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_DFU_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable LOWSPP
// <i> Enable m_ble_lowspp.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_LOWSPP_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable MTU
// <i> Enable m_ble_mtu.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_MTU_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable BATT
// <i> Enable m_batt_meas.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_BATT_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable BTN_ACT
// <i> Enable m_drv_btn_action.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_BTN_ACT_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable Button
// <i> Enable m_button.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_BUTTON_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable WatchHand
// <i> Enable m_watch_hand.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_WATCH_HAND_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable DrvWatchHand
// <i> Enable drv_watch_hand.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_DRV_WATCH_HAND_ENABLED (0 && CONFIG_DEBUG_ENABLED)
...
/**@brief Debug Build */
#define CONFIG_RTT_DRV_LED_ENABLED (1 && CONFIG_DEBUG_ENABLED)
...
/**@brief Debug Build */
#define CONFIG_RTT_SPI_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable W25QXX Flash
// <i> Enable m_drv_w25x80.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_W25X80_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable Leds
// <i> Enable m_leds.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_LEDS_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable Leds
// <i> Enable m_vibrator.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_VIBRATOR_ENABLED (1 && CONFIG_DEBUG_ENABLED)
...
/**@brief Debug Build */
#define CONFIG_RTT_FLASH_OP_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable FS
// <i> Enable m_fs.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_FS_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable protocol.c
// <i> Enable proto.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_PORTO_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable Pack Send
// <i> Enable m_pack_send.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_PACK_SEND_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable Event Bus
// <i> Enable event_bus.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_EVENT_BUS_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable M_COMS
// <i> Enable m_coms.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_COMS_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable M_COMS_BLE
// <i> Enable m_coms_ble.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_COMS_BLE_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable DataBase
// <i> Enable m_database.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_DATABASE_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable SYS
// <i> Enable m_system_state.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_SYS_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable Main
// <i> Enable main.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_MAIN_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable system_state
// <i> Enable m_system_state.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_SYSTEM_STATE_ENABLED (1 && CONFIG_DEBUG_ENABLED)


// <q> Enable BLE CONN PARAMS
// <i> Enable ble_conn_params.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_CONN_PARAMS_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable Driver Magnet
// <i> Enable m_geo.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_MAG_ENABLED (1 && CONFIG_DEBUG_ENABLED)

// <q> Enable Driver mag
// <i> Enable drv_mag.c RTT.
/**@brief Debug Build */
#define CONFIG_RTT_DRV_MAG_ENABLED (1 && CONFIG_DEBUG_ENABLED)
...
#define WH_IND_STEPS_POS_START      15
#define WH_IND_STEPS_POS_END        45
#define WH_IND_STEPS_INTV_NUM       30
#define WH_IND_STEPS_INTV           3.3 //(100/WH_IND_STEPS_INTV_NUM)


#define WH_IND_POS_STEPS_GOAL_FINISHED WH_IND_STEPS_POS_END
