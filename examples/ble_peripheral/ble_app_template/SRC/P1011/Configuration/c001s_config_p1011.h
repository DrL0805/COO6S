...
#ifndef _C001S_CONFIG_P1011_H
#define _C001S_CONFIG_P1011_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h> C001S Base Board Features

// <q> Enable Button Enter Dfu
// <i> 按按键进 DFU 模式
#define CONFIG_BUTTON_ENTER_DFU_ENABLED 0
...
// <i> 低于该值，为低电状态
#define CONFIG_BATT_MEAS_LOWPOWER_LEVEL (2800 - 340)   /*电压比较低时，adc检测电压会拉低电池电压会有350mv以上  2750-350*/
...
#define CONFIG_DEVICE_NAME "DMAP"

// <s.31> Project Num
// <i> UTF-8 string representing the name of the device.
#define CONFIG_PROJECT_NUM "P1011"
...
// <i> 产品固件版本号: 测试版本号，十进制
#define CONFIG_PRODUCT_FW_VER_TEST 63
...
#define CONFIG_ADV_INTERVAL_SLOW_MS 500
...
#define CONFIG_MIN_CONN_INTERVAL_MS 300
...
#define CONFIG_MAX_CONN_INTERVAL_MS 400
...
#define CONFIG_MAX_CONN_PARAMS_UPDATE_COUNT 1
// </h>
...
//     <24=>P0.24 <25=>P0.25 <26=>P0.26 <27=>P0.27 <28=>P0.28 <29=>P0.29 <30=>P0.30 <31=>P0.31
//     <0xFFFFFFFF=>Disable
#define CONFIG_IO_BUTTON_0 0x0000000E
...
//     <24=>P0.24 <25=>P0.25 <26=>P0.26 <27=>P0.27 <28=>P0.28 <29=>P0.29 <30=>P0.30 <31=>P0.31
//     <0xFFFFFFFF=>Disable
#define CONFIG_IO_BUTTON_WAKEUP 0x0000000E
